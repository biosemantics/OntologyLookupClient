package edu.arizona.sirls.knowledge;
...
public class PermittedRelations {	
	...
	public static QualityProposals matchInPermittedRelation(String relation, boolean negation,int flag) {
		...
		relation = edu.arizona.sirls.utilities.Utilities.removeprepositions(relation);
		...
		SearchMain.ontoutil.searchOntologies(relation, "quality", results);
		if(results.size()==0)
		{
