...
import edu.arizona.biosemantics.oto.ontologylookup.data.Quality;
...
import edu.arizona.biosemantics.oto.ontologylookup.knowledge.Wordforms;
...
public class TermSearcher {
	 ...
	 * ArrayList<Hashtable<String, String>> ();
	 * EntitySearcherOriginal.ontoutil.searchOntologies(phrase, phrasetype, searchresult);
