package edu.arizona.biosemantics.oto.ontologylookup.knowledge;
...
import edu.arizona.biosemantics.oto.ontologylookup.owlaccessor.OWLAccessorImpl;
...
//		measureantonyms.put("broad", "narrow");
	...
	static{	
		...
		for(String key:keys)
		{
			...
			relation = edu.arizona.biosemantics.oto.ontologylookup.utilities.Utilities.removeprepositions(relation.trim());
